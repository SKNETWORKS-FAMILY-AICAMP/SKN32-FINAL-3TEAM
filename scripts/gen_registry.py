...
ATTRIB: dict[str, tuple[str | None, str | None]] = {
    ...
    "aihub_558": (
        "CC BY-SA (🔴 버전 미확인 — 원천 페이지에서 확인이 남았다)",
        "「텍스트 윤리검증 데이터」(NIA · 심심이(주)), AI Hub, CC BY-SA",
    ),
    "klue_dataset": (
    ...
    "nsmc": (
        "CC BY 2.0 (HF 상단 메타데이터) · GitHub 은 CC0 1.0 — 엄격한 쪽을 따른다",
    ...
    # ③ 의무가 없다 — 기관명·자료명·식별번호를 옮겨 적었을 뿐이다
    "cosmetic_ingredient": (
        _LIC_OPEN,
    ...
    # 🔴 ④ 근거가 없다 — attribution 을 비워 둔다. 비어 있다는 사실 자체가 기록이다
    "kcia_guideline": (
        "🔴 없음 — 원천에 이용조건 문구가 없다 (2026-09-02 탐침 · 확인 항목 4). "
        "민간 협회 저작물이라 「조건 없음」은 「자유」가 아니다. 협회 회신 대기 (2026-09-09)",
        None,
    ),
}
