...
원천 둘 —
  `mfds_hf_ingredient`  I-0040 기능성 원료인정 현황   773행 (`FNCLTY_CN`)
  `mfds_hf_individual`  I-0050 개별인정형 정보        447행 (`PRIMARY_FNCLTY`)

🔴 **위 두 수는 2026-09-10 에 정정됐다** (D-54). 종전에는 873 · 547 로 적혀 있었는데
   원천 신고값도, 09-06 에 받아 둔 장수도 그 수가 아니었다 — ingredient 는 8장(700+73),
   individual 은 5장(400+47)이다. **둘 다 정확히 한 장(100행)씩 많았다.**
   ⛔ 같은 docstring 의 파생 수치(768 · 444 · 465 · 합집합 781 · 새로 얻는 것 316)는
      전부 실측과 맞는다. **원본 두 줄만 다른 곳에서 옮겨 적힌 것**이다 —
      맞는 수와 틀린 수가 한 문단에 나란히 있으면 틀린 쪽이 안 보인다.
