...
![decisions](https://img.shields.io/badge/설계결정-D--230-2B5BD7?style=flat-square)

**[📌 중간 발표 자료](발표자료/중간발표_2026-09-15/)** · [설계 결정 230건](docs/00_설계결정기록.md) · [사실 원장](docs/00_사실원장.md) · [고지](DISCLAIMER.md)
...
| [`docs/00_설계결정기록.md`](docs/00_설계결정기록.md) | ★ **결정 230건.** 맥락 · 대안 · 트레이드오프 · 왜 기각했는지 |
